<?php 
/* lambdaspeech | copyleft_GPL alainmarty 2021-22  updated on 20211111 */
// called by index.php
...
/////////////////////////////////////////////////////////////////////////////
    ...
    date_timezone ();
      ...
      //     .     "<div id='page_foot'><a href='http://lambdaway.free.fr/lambdaspeech/'>".VERSION."</a></div>\n"
           .     "<div class='page_menu'><a href='http://lambdaway.free.fr/'>".VERSION."</a></div>\n"
...
/////////////////////////////////////////////////////////////////////////////
    ...
    // doLogs( $page );  // correction 20210324
		if (!preg_match('/^_/', $page)) doLogs( $page );
      ...
      $file_content = doControlPage( file_get_contents(PAGES.$page.'.txt') );
		...
		$body = "<div class='page_menu' onmousedown='DRAG.beginDrag( this.parentNode, event );'>"
          ...
          .        "<span title='lock/unlock evaluation'>" . menu_lock() . "</span>"
          .      "</div>"
		      .      "<textarea id='page_textarea' name='content' onkeyup='LAMBDATANK.update(false)' placeHolder='Please, edit...'>\n"
          .        $file_content
          .      "</textarea>\n"
		      .   "</form>\n"
          .  "</div>\n"
  ...
  function menu_lock () {
    return "<input type='button' value='lock' onclick='LAMBDATANK.toggle_lock(this)' />";
  }
  function menu_load () {
    global $g_validUser;
...
/////////////////////////////////////////////////////////////////////////////
	function doSave () {
		...
		// doLogs( 'save' ); // correction 20210324
    ...
    global $g_validUser;
		...
		// doLogs( 'load' ); // correction 20210324
...
/////////////////////////////////////////////////////////////////////////////
  ...
  function doControlPage( $chaine ) {
    ...
    $referer = 'unknown';     // edited on 2021/03/27
