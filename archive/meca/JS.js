...
LAMBDATALK.DICT["uncover"] = function() {
  ...
  var foo = "this.style.height=(this.style.height==='" +h1+ "px')? '" +h2+ "px' : '" +h1+ "px';"
          + "this.nextSibling.style.fontSize=(this.nextSibling.style.fontSize==='0px')? '1.0em' : '0px';"

  return '<img src="' +im+ '" ' +
         'style="width:100%; height:'+h1+'px; object-fit:cover; cursor:zoom-in; transition: all 1s;"' +
         'onclick="' +foo+ '" /><div style="font-size:0px; text-align:center; ">' +txt+ '</div>'
};
